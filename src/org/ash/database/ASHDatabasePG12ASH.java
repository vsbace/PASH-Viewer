/*
 *-------------------
 * The ASHDatabasePG12ASH.java is part of ASH Viewer
 *-------------------
 *
...
/**
 * The Class ASHDatabasePG12ASH.
 */
public class ASHDatabasePG12ASH extends ASHDatabase {
     ...
     */
    public ASHDatabasePG12ASH(Model model0) {
        super(model0);
        this.model = model0;
