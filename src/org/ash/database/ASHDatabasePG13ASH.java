/*
 *-------------------
 * The ASHDatabasePG13ASH.java is part of ASH Viewer
 *-------------------
 *
...
/**
 * The Class ASHDatabasePG13ASH.
 */
public class ASHDatabasePG13ASH extends ASHDatabase {
     ...
     */
    public ASHDatabasePG13ASH(Model model0) {
        super(model0);
        this.model = model0;
