/*
 *-------------------
 * The ASHDatabasePG14ASH.java is part of ASH Viewer
 *-------------------
 *
...
/**
 * The Class ASHDatabasePG14ASH.
 */
public class ASHDatabasePG14ASH extends ASHDatabase {
     ...
     */
    public ASHDatabasePG14ASH(Model model0) {
        super(model0);
        this.model = model0;
