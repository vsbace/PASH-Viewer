...
public class Settings extends JDialog {
    ...
    private JPanel explainPanelCommon = new JPanel();
    ...
    // Buttons for explain settings
    private JRadioButton _00RadioButtonExplain = new JRadioButton();
    private JRadioButton _10RadioButtonExplain = new JRadioButton();
    private JRadioButton _60RadioButtonExplain = new JRadioButton();
    private JRadioButton _600RadioButtonExplain = new JRadioButton();
    ...
    private ButtonGroup buttonGrExplain = new ButtonGroup();
    ...
    private void InitializesJDialog() {
        ...
        this._00RadioButtonExplain.setText("Off");
        this._00RadioButtonExplain.addItemListener(new SelectItemListenerRadioButtonExplain());
        this._10RadioButtonExplain.setText("10sec");
        this._10RadioButtonExplain.addItemListener(new SelectItemListenerRadioButtonExplain());
        this._60RadioButtonExplain.setText("1min");
        this._60RadioButtonExplain.addItemListener(new SelectItemListenerRadioButtonExplain());
        this._600RadioButtonExplain.setText("10min");
        this._600RadioButtonExplain.setSelected(true);
        this._600RadioButtonExplain.addItemListener(new SelectItemListenerRadioButtonExplain());
        ...
        this.buttonGrExplain.add(_00RadioButtonExplain);
        this.buttonGrExplain.add(_10RadioButtonExplain);
        this.buttonGrExplain.add(_60RadioButtonExplain);
        this.buttonGrExplain.add(_600RadioButtonExplain);
        ...
        explainPanelCommon.setLayout(gridBagLayoutCommon1);
        titledSelectionModeTopA = BorderFactory.createTitledBorder(loweredetched, "Explain Frequency");
        addCompForTitledBorder(titledSelectionModeTopA,
                TitledBorder.LEFT,
                TitledBorder.DEFAULT_POSITION,
                explainPanelCommon);
...
/*
        ...
        mainPanelCommon.add(explainPanelCommon,				new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,	  new Insets(5, 5, 5, 5), 0, 0));
        ...
        explainPanelCommon.add(_00RadioButtonExplain,	new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.VERTICAL, new Insets(5, 5, 5, 5), 0, 0));
        explainPanelCommon.add(_10RadioButtonExplain,	new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.VERTICAL, new Insets(5, 5, 5, 5), 0, 0));
        explainPanelCommon.add(_60RadioButtonExplain,	new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.VERTICAL, new Insets(5, 5, 5, 5), 0, 0));
        explainPanelCommon.add(_600RadioButtonExplain,	new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.VERTICAL, new Insets(5, 5, 5, 5), 0, 0));
    ...
    class SelectItemListenerRadioButtonExplain implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent e) {
            ...
            //checkbox select or not
            if (e.getStateChange() == ItemEvent.SELECTED) {
                if (sel.getText().equals("Off")) {
		    Options.getInstance().setExplainFreq(0);
                } else if (sel.getText().equals("10sec")) {
		    Options.getInstance().setExplainFreq(10000);
                } else if (sel.getText().equals("1min")) {
		    Options.getInstance().setExplainFreq(60000);
                } else if (sel.getText().equals("10min")) {
		    Options.getInstance().setExplainFreq(600000);
                }
            }
        }
    }
